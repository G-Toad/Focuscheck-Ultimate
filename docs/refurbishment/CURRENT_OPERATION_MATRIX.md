...
| Launch | Supervised start | `focuscheck_supervisor.py` owns heartbeat, generation, nonce-bound stop requests, stale detection, and bounded restart behavior. | `automated`; live restart `manual_pending` |
