...
| Packaging | Build | Current source has a pinned PyInstaller build, SHA-256 manifest validation, and packaged supervisor READY/stop/reaping self-test. | `automated`; current candidate recorded in `PACKAGE_EVIDENCE.md` |
