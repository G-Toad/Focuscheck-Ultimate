...
- Current verification rerun: `168` unittest cases pass; it additionally covers cancellation-aware supervisor waits, durable generation-bound stop acknowledgement, pause-guard native failure diagnostics, and startup legacy/duplicate inspection and repair.
