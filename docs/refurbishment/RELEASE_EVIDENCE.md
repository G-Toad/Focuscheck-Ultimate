...
- Current verification rerun: `167` unittest cases pass; it additionally covers cancellation-aware supervisor waits, durable generation-bound stop acknowledgement, and pause-guard native failure diagnostics.
