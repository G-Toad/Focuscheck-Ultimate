...
The current automated baseline is `524` tests across 19 bounded stages at source checkpoint `080b718`; the detailed older bullets are retained as historical baseline context.
