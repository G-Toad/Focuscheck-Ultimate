...
- Current verification rerun: `166` unittest cases pass; it additionally covers cancellation-aware supervisor waits and durable generation-bound stop acknowledgement.
