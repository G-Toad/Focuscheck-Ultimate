...
- Current verification rerun: `169` unittest cases pass; it additionally covers cancellation-aware supervisor waits, durable generation-bound stop acknowledgement, pause-guard native failure diagnostics, startup legacy/duplicate inspection and repair, and single-instance mutex handle release.
