...
The current automated baseline is `527` tests across 19 bounded stages at source checkpoint `3913604`; the detailed older bullets are retained as historical baseline context.
