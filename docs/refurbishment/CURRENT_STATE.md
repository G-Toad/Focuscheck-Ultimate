...
- Settings inventory now distinguishes editor references from runtime consumers and proves all 207 visible save keys have a non-editor consumer, including dynamic challenge controls.
