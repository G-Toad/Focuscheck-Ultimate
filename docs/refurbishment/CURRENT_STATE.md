...
- Latest verified source checkpoint: `8814d0f`; 568 unittest cases and all 20 bounded verification stages pass with zero process leaks. Intensification stage-5 positioning and overlay cleanup now reuse declared native User32/GDI contracts. Manual Windows and release evidence remains pending.
