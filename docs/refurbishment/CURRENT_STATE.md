...
- Latest verified source checkpoint: `a948f12`; 554 unittest cases and all 19 bounded verification stages pass. Engine replacement, timer registration, and V2 pause/guard/snooze/tray/intervention polling paths are failure-safe; manual Windows and release evidence remains pending.
