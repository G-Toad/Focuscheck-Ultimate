...
This proves the source package build and packaged self-test only. Installer lifecycle, upgrade/rollback, code signing, and native manual evidence remain open.
